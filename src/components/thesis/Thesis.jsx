...
class Thesis extends React.Component {
	getStyles() {
		return {
			banner: {
				background: `url(${require('../../assets/img/news.jpg')}) no-repeat center center/cover fixed`,
				height: '75vh',
				width: '100%',
				textAlign: 'center',
				color: 'white',
			...
			<div>
				  ...
				  <Grid container style={styles.banner} spacing={0} alignItems='center' justify='center'>
				    <Grid item xs={12}>
				      <Grid container spacing={0} justify='center' alignItems='center' style={styles.bannerText}>
				        <p style={styles.pageHeading}> computational methods for the discovery and detection of media frames in online news </p>
				      </Grid>
				    </Grid>
				  </Grid>
				</Grid>
				<Grid container style={styles.intro} spacing={0}>
					<Grid item xs={6} style={styles.descriptionTitle}>
						...
						<p> The news directs the conversations we have as a society </p>
					</Grid>
					<Grid item xs={6} style={styles.introTextRight}>
						<p> {"How does the news shape our view of issues and events?\
								...
								the attention to and framing of issues can affect how we talk about and understand events in our world."}
						</p>
					</Grid>
				</Grid>
				<Grid container style={styles.intro} spacing={0}>
				...
				<Grid container style={styles.intro} spacing={0} >
					...
					<Grid item xs={6} style={styles.introTextRight}>
						<p>
							My thesis explores which machine learning and visualization methods
				...
				<Grid container justify='center' alignItems='center' spacing={0} style={styles.featureIntro}>
					<pre style={styles.featureIntroText}> - S A M P L E      F E A T U R E S - </pre>
				</Grid>
						...
						<div>
							<p>
								{"When researchers are unsure of what the frames of a topic may be, \
									...
									a neural net, can be used to determine if a group of words \
									frequently appear in similar contexts within a text corpus. \
									Using a word cloud of the most frequently used words within a news topic \
									where the position of a word is determined by a 2D representation of its embedding, \
